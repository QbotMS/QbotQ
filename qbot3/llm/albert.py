...
- Prośba o PRZELICZENIE / odświeżenie trasy ("przelicz trasę X", "odśwież trasę", po odmowie w Telegramie) → route_recompute (WYMAGA route_id; przelicza AKTYWNĄ najnowszą wersję; operacja ciężka i zapisująca; po sukcesie zostają 3 najnowsze wersje). Przeliczanie STARSZEJ wersji będzie osobno.
