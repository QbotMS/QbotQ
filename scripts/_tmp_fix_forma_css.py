...
css='''.drow{display:grid;grid-template-columns:70px 80px 1fr 130px 1fr 20px;gap:4px 10px;align-items:center;padding:7px 0;border-bottom:1px solid var(--line);font-size:14px;cursor:pointer}
